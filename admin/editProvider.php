...
if(isset($_POST['ajax']) && isset($_POST['country_id'])){
  ...
  if(isset($_FILES['addImg'])){
    ...
    echo "<script type='text/javascript'>window.top.location='editProvider.php?provider_id=$provider_id&active=4';</script>"; exit;
  }
  ...
  if(isset($_POST['edit_company'])){
    ...
    echo "<script type='text/javascript'>window.top.location='editProvider.php?provider_id=$provider_id&active=1';</script>"; exit;
  }
  ...
  if(isset($_POST['edit_login'])){
    ...
    echo "<script type='text/javascript'>window.top.location='editProvider.php?provider_id=$provider_id&active=2';</script>"; exit;
  ...
  if(isset($_POST['edit_address'])){
    ...
    echo "<script type='text/javascript'>window.top.location='editProvider.php?provider_id=$provider_id&active=3';</script>"; exit;
  }
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="tab-content mt-4" id="myTabContent">
                            ...
                            <div class="tab-pane fade <?php if($active_num == 1) echo "show active"; ?>" id="home"
                                ...
                                <!-- start form -->
                                <form id='edit_company' action="editProvider.php?provider_id=<?php echo $provider_id; ?>" method="post"
                            ...
                            <div class="tab-pane fade <?php if($active_num == 2) echo "show active"; ?>" id="profile"
                                ...
                                <!-- start form -->
                                <form id='edit_login' action="editProvider.php?provider_id=<?php echo $provider_id; ?>" method="post">
                                    <input type='hidden' name='provider_id' value='<?php echo $row['provider_id'];?>'>
                                    <div class="form-group">
                                        <div class="input-group">
                            ...
                            <div class="tab-pane fade <?php if($active_num == 3) echo "show active"; ?>" id="contact"
                                ...
                                <!-- start form -->
                                <form id='edit_address' action="editProvider.php?provider_id=<?php echo $provider_id; ?>" method="post">
                                    <input type='hidden' name='provider_id' value='<?php echo $row['provider_id'];?>'>
                                    <div class="form-group">
                                        <div class="input-group">
                                    ...
                                    <div class="card-header bg-dark text-light">
                                        <div class="row">
                                            ...
                                            <div class="col-4 d-flex justify-content-end align-items-center">
                                                <form id="addImage"
                                                    action="editProvider.php?provider_id=<?php echo $provider_id; ?>"
