                    ...
                    if(mysqli_num_rows($resultProvider) > 0){
                      ...
                      while($row = mysqli_fetch_assoc($resultProvider)){ ?>
                             ...
                             ?>
                                    ...
                                    <td>
                                        <div class="col-12">
                                            <a class="btn btn-sm btn-primary mb-1 w-100" href="editProvider.php?provider_id=<?php echo $row['provider_id'];?>&active=1">Edit Provider</a>
                                        </div>
                                        <div class="col-12">
                                            <a href="../public/company_details.php?provider_id=<?php echo $row['provider_id']; ?>" class="btn btn-sm btn-info mb-1 w-100 m-0" target="_blanck">Info.</a>
                                        </div>
                                        <div class="col-12">
                                            <form id="option<?php echo $i;?>Del" action="provider.php" method="post">
                                                ...
                                                <button class="btn btn-danger btn-sm w-100" type="submit" name="remove"
